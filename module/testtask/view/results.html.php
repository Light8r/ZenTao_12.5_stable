                                ...
                                <table class='table table-condensed resultSteps'>
                                    ...
                                    <?php if($result->caseResult == 'fail'):?>
                                        <tr>
                                            ...
                                            <?php
                                            $casePri = (int)$case->pri;
                                            $bugLink = $this->createLink('bug', 'create',
                                                "product=$case->product&branch=$case->branch&extras=caseID=$case->id,version=$case->version,resultID=$result->id,runID=$runID,casePri=$casePri$params");
                                            echo "<td>" . html::a($bugLink, $lang->testcase->createBug, '_blank', "class='btn btn-primary'") . "</td>";
                                            ?>
                                        </tr>
                                    <?php endif;?>
                                    </tbody>
